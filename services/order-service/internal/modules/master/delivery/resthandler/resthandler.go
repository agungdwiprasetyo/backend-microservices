...
func NewRestHandler(mw interfaces.Middleware, uc usecase.MasterUsecase, validator interfaces.Validator) *RestHandler {
	return &RestHandler{
...
func (h *RestHandler) Mount(root *echo.Group) {
	...
	master := v1Root.Group("/master")
	master.GET("", h.hello, echo.WrapMiddleware(h.mw.HTTPBearerAuth))
}
