...
func NewGraphQLHandler(mw interfaces.Middleware, uc usecase.AuthUsecase, validator interfaces.Validator) *GraphQLHandler {
...
func (h *GraphQLHandler) RegisterMiddleware(mwGroup *types.MiddlewareGroup) {
	mwGroup.Add("AuthQueryModule.hello", h.mw.GraphQLBearerAuth)
	mwGroup.Add("AuthMutationModule.hello", h.mw.GraphQLBasicAuth)
}
